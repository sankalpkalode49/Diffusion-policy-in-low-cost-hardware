...
class SO100HybridRecorder(Node):
    def __init__(self):
        ...
        self.get_logger().info("🚀 Starting 3-Axis (Planar + Gripper) Hardware + LeRobot Data Collector...")
        ...
        # 🚨 ACTIVE 3-AXIS TOPOLOGY (Base Motor 1 completely removed)
        ...
        self.last_sent_targets = {2: -1, 3: -1, 6: -1}
        self.motor_ids = [2, 3, 6]  # Active control chain
        ...
        self.get_logger().info("✅ Torque enabled. Planar links and gripper locked in.")
        ...
        # Array shapes strictly set to 3 to handle [Shoulder, Elbow, Gripper]
    ...
    def main_loop(self):
        ...
        # Send commands to functional hardware
        for motor_id in self.motor_ids:
        ...
        if self.is_recording:
            ...
            # Pack array of exactly length 3: [Shoulder, Elbow, Gripper]
